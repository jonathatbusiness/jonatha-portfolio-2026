...
export const projectsPt: Project[] = [
  {
    ...
    services: ["Desenvolvimento em Storyline", "Identidade visual", "Design de interface", "Criação de ativos", "Adaptação de conteúdo", "Suporte instrucional"],
    ...
    seo: {
      ...
      description: "Estudo de caso de uma experiência interativa desenvolvida para o programa Canteiro de Ideias da Cotrijal, com identidade visual, Storyline e suporte em design instrucional.",
    },
  },
  {
    ...
    client: "Cotrijal",
    subtitle: "Roteiro, narrativa, direção visual e edição desenvolvidos em uma semana para uma apresentação de alto impacto.",
    ...
    featured: true,
    status: "completed",
    role: ["Editor de vídeo", "Designer de motion", "Narrativa visual", "Adaptação de roteiro"],
    services: ["Narrativa audiovisual", "Adaptação de roteiro", "Edição de vídeo", "Direção visual", "Seleção de ativos", "Motion design"],
    tools: ["Adobe After Effects", "Adobe Photoshop"],
    tags: ["Narrativa", "Edição de vídeo", "Motion design"],
    ...
    content: {
      ...
      challenge: ["O prazo total era de aproximadamente uma semana, incluindo roteiro, narrativa, ativos, imagens, música, edição e finalização.", "Também era necessário preservar a coerência narrativa durante revisões internas."],
      role: ["Fui responsável pela adaptação e reescrita do roteiro, construção da narrativa, seleção de ativos, direção visual, edição, montagem e escolha das músicas."],
    ...
    seo: { title: "EvoluIR Cotrijal — Vídeo de Apresentação | Jonatha Teixeira", description: "Estudo de caso de vídeo institucional com narrativa, direção visual, edição e motion design para a plataforma EvoluIR Cotrijal." },
  },
  {
    slug: "jonjobs-h2",
    area: areas.digital,
    ...
    featured: true,
    status: "active",
    role: ["Designer de produto", "Arquiteto de solução", "Designer UX/UI", "Construção assistida por IA", "Responsável pelo produto"],
    services: ["Estratégia de produto", "Arquitetura de solução", "UX", "Design de UI", "Organização de dados", "Automação", "Monetização", "Implementação assistida por IA"],
    ...
    content: {
      ...
      note: ["Não há métricas comerciais ou depoimentos públicos apresentados neste estudo de caso."],
    },
    seo: { title: "JonJobs H2 — Produto Digital para Vagas H-2B | Jonatha Teixeira", description: "Estudo de caso de produto digital com UX/UI, arquitetura de solução e desenvolvimento assistido por IA para candidaturas H-2B." },
  },
];
...
const remainingPt: Project[] = [
  {
    ...
    featured: false,
    status: "completed",
    role: ["Desenvolvedor Storyline", "Designer visual", "Designer de ativos"],
    services: ["Desenvolvimento em Storyline", "Direção visual", "Sistema visual para cursos", "Design de interface", "Criação de ativos", "Prototipação"],
    tools: ["Articulate Storyline 360", "Adobe Photoshop", "Adobe Illustrator"],
    ...
    content: {
      ...
      role: ["Atuei como desenvolvedor Storyline e designer visual, com foco em transformar o material fornecido em uma experiência digital visualmente consistente e tecnicamente funcional."],
      ...
      solution: ["O protótipo foi apresentado dentro do prazo e aprovado pelo cliente, passando a orientar layouts, navegação, recursos gráficos, interações e ativos dos demais cursos."],
      outcome: ["A aprovação recuperou o andamento do projeto e estabeleceu uma direção visual reutilizável para toda a série."],
      note: ["Este estudo de caso descreve desenvolvimento em Storyline, design visual, interface de curso e criação de ativos, sem apresentar Jonatha como designer instrucional principal."],
    },
    seo: { title: "Jornada do Pós-venda — Storyline e Sistema Visual | Jonatha Teixeira", description: "Estudo de caso de curso interativo em Storyline para Todeschini, com direção visual e sistema de interface para trilha de pós-venda." },
  },
  {
    ...
    seo: { title: "Mini MIV Classic — Identidade Visual | Jonatha Teixeira", description: "Estudo de caso de identidade visual e diretrizes essenciais para Classic Administrações e Participações." },
  },
  {
    slug: "jonjobs-canada",
    area: areas.digital,
    ...
    featured: false,
    status: "active",
    role: ["Designer de produto", "Designer UX/UI", "Arquiteto de solução", "Construção assistida por IA", "Estrategista de conteúdo"],
    services: ["Estratégia de produto", "Pesquisa de requisitos", "UX", "Design de UI", "Filtros e taxonomia", "Gerador de currículo", "Internacionalização", "Implementação assistida por IA"],
    ...
    content: {
      ...
      solution: ["A busca destaca província, NOC, recência, LMIA e abertura internacional; o gerador orienta a criação de currículo compatível com ATS e exportação em PDF."],
    ...
    seo: { title: "JonJobs Canada — Produto Digital para Busca de Empregos | Jonatha Teixeira", description: "Estudo de caso de produto digital com UX/UI, filtros para candidatos internacionais e gerador de currículo ATS." },
  },
  {
    ...
    services: ["Desenvolvimento no Genially", "Gamificação", "Design visual", "Criação de ativos", "Adaptação instrucional", "Design de interação"],
    ...
    seo: { title: "Diversidade Cotrijal — Genially e Gamificação | Jonatha Teixeira", description: "Estudo de caso de curso gamificado sobre diversidade desenvolvido no Genially com suporte instrucional e design visual." },
  },
  {
    ...
    services: ["Adaptação de conteúdo", "Narrativa audiovisual", "Direção visual", "Edição", "Seleção de imagens", "Motion design"],
    tools: ["Adobe After Effects", "Adobe Photoshop"],
    ...
    seo: { title: "Transformação e Experiência do Cliente — Vídeo Institucional | Jonatha Teixeira", description: "Estudo de caso de vídeo institucional para C&C com narrativa audiovisual, direção visual e edição." },
  },
  {
    slug: "discerenow",
    area: areas.digital,
    ...
    featured: false,
    status: "beta",
    role: ["Designer de produto", "Designer de tecnologia educacional", "Arquiteto de solução", "Designer UX/UI", "Construção assistida por IA"],
    services: ["Estratégia de produto", "Tecnologia educacional", "Arquitetura de solução", "UX", "Design de UI", "Modelagem de conteúdo", "Fluxo Word para SCORM", "Implementação assistida por IA"],
    ...
    content: {
      ...
      outcome: ["O site, o Template Builder e a proposta do Studio foram desenvolvidos como um produto em evolução. O Studio deve ser identificado como beta."],
    },
    seo: { title: "DiscereNow — Tecnologia Educacional e SCORM | Jonatha Teixeira", description: "Estudo de caso de produto digital para transformar documentos Word estruturados em cursos SCORM ou Web." },
  },
  {
    slug: "selected-social-media-work",
    area: areas.visual,
    title: "Trabalhos selecionados para redes sociais",
    ...
    media: [
      ...
      { type: "carousel", src: "/images/projects/selected-social-media-work/06.webp", alt: "Layout para redes sociais com identidade adaptada ao contexto da marca." },
    ],
    content: {
      ...
      solution: ["O estudo de caso é apresentado como uma seleção visual, sem criar histórias específicas ou responsabilidades não confirmadas para cada peça."],
    ...
    seo: { title: "Trabalhos Selecionados para Redes Sociais — Design Visual | Jonatha Teixeira", description: "Seleção de peças para redes sociais com composição visual, hierarquia, tratamento de imagem e adaptação de identidade." },
  },
];
...
const roleTranslations: Record<string, string> = {
  ...
  "Designer de motion": "Motion Designer",
  ...
  "Designer de ativos": "Asset Designer",
...
const serviceTranslations: Record<string, string> = {
  ...
  "Criação de ativos": "Asset creation",
  ...
  "Seleção de ativos": "Asset selection",
